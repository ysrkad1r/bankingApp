...
public class DepositPanel extends JPanel implements Resettable {
    ...
    public DepositPanel(MainFrame frame , BankController bankController) {
        this.frame = frame;
        ...
        depositLabel.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 16));
        ...
        add(new JLabel());
        add(depositButton, "height 40!, width 320!, wrap");
        ...
        depositButton.addActionListener(e -> {
            ...
            bankController.handleDepositMoney(String.valueOf(selectedAccount.getId()), amountField.getText(), this);
        });
